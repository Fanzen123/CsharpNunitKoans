...
namespace TheKoans
{
	...
	public class K020_AboutVariables : KoanHelper
	{
		...
		public void ExplicitAssignmentByCasting ()
		{
			...
			Assert.AreEqual (Convert.ToDouble(canDoThis), canDoThis, "Notice how the information is changed/lost in the conversion. This is why the compiler cannot implicitly do it.");
		}
